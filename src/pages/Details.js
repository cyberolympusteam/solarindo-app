...
export default class Details extends React.Component {
  ...
  getLighting = () => {
    ...
    axios({
      method: 'get',
      url:
        'https://solarindo.indorobotik.com/api/v1/media/show/' +
        this.state.media_id,
      headers: {
      ...
      <View style={style.container}>
        ...
        <ScrollView style={style.defaultScroll}>
          <View style={style.containerPanel}>
            <Image
              style={styles.logo}
              //   Tidak dapat menampilkan gambar karena gambar diambil dilocal hp, solusi dijadikan base64/link
              source={{uri: this.state.dataLighting.picture}}
            />
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.name}
              </Text>
            </View>
            <View style={[styles.listTitle]}>
              <Text style={[style.h5, {color: '#666'}]}>POLE ID</Text>
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.pole_id}
              </Text>
            </View>
            <View style={[styles.listTitle]}>
              <Text style={[style.h5, {color: '#666'}]}>ADDRESS</Text>
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.address}
              </Text>
            </View>
            <View style={[styles.listTitle]}>
              <Text style={[style.h5, {color: '#666'}]}>ZONE</Text>
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.zone}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.manufacture_year}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.category}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.longitude}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.latitude}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.pole_brand}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.pole_type}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.pole_body}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.pole_height}
              </Text>
            </View>
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.planted_ground}
              </Text>
            </View>
          </View>
        </ScrollView>
