...
export default class ReportDetails extends React.Component {
  ...
  getLighting = () => {
    ...
    axios({
      method: 'get',
      url:
        'https://solarindo.indorobotik.com/api/v1/report/show/' +
        this.state.media_id,
      headers: {
      ...
      <View style={style.container}>
        ...
        <ScrollView style={style.defaultScroll}>
          <View style={style.containerPanel}>
            <Image
              style={styles.logo}
              source={{uri: this.state.dataLighting.created_photo}}
            />
            ...
            <View style={[styles.listTitle]}>
              ...
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.number}
              </Text>
            </View>
            <View style={[styles.listTitle]}>
              <Text style={[style.h5, {color: '#666'}]}>CREATED BY</Text>
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.created_by}
              </Text>
            </View>
            <View style={[styles.listTitle]}>
              <Text style={[style.h5, {color: '#666'}]}>CREATED NOTES</Text>
              <Text style={[style.h2, {color: '#0B108C'}]}>
                {this.state.dataLighting.created_notes}
              </Text>
            </View>
          </View>
        </ScrollView>
